...
//        clearTela();
    ...
    public void ClienteTela(){
        ...
        if(Valor.equals("2")){
            ...
            Cliente cliente = _db.Clientes
                    ...
                    .findFirst()
                    .orElse(null);
            if(Name != null && Password == cliente.getSenha()){
                System.out.println("----------------------------------------------------------------");
                System.out.println("              Eae, " + Name);
                System.out.println("----------------------------------------------------------------");
                TelaCliente();
            }
            if(Name == null && Password != cliente.getSenha()){
    ...
    public void ClienteCadastro(){
        ...
        _db.SalvarCliente(); // adiciona essa linha para salvar o Cliente no arquivo
            ...
            if (Parametro != null) {
                ...
                if (produto != null) {
                    ...
                    if(Comp.equalsIgnoreCase("S".replace(" ",""))){
                        ...
                        System.out.println("-------------------------------------");
                        try{
                            Thread.sleep(500); // Pausa a execução por 5 segundos
